...
/**
 * Direct shortcut route: /bookos
 * Automatically resolves user's language preference and routes to /{lang}/projects/bookos
 */
export default function BookOSShortcutPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/${lang}/projects/bookos`);
  }, [router]);
