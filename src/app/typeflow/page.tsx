...
/**
 * Direct shortcut route: /typeflow
 * Automatically resolves user's language preference and routes to /{lang}/projects/typeflow
 */
export default function TypeFlowShortcutPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/${lang}/projects/typeflow`);
  }, [router]);
